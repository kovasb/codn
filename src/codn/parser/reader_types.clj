...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? codn.parser.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? codn.parser.reader_types.PushbackReader rdr))
           (not (instance? codn.parser.reader_types.StringReader rdr))
           (not (instance? codn.parser.reader_types.InputStreamReader rdr))
